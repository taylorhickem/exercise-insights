...
def lifts_update():
    ...
    gs_lifts = lifts.copy()
    #date_format = ds.db.GSHEET_CONFIG['exercise']['sheets']['lifts']['date_format']
    #gs_lifts['date'] = gs_lifts['date'].apply(lambda x: x.strftime(date_format))

    #04 post to gsheet
    ds.db.post_to_gsheet(gs_lifts, 'exercise', 'lifts', input_option='USER_ENTERED')
